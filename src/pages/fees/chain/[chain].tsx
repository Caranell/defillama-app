...
export const getStaticProps = withPerformanceLogging(
	...
	async ({ params }: GetStaticPropsContext<{ chain: string }>) => {
		...
		const redirectDestination = getChainRouteRedirectDestination(params.chain, chainRoute, 'fees/chain')
		...
		if (!data) throw new Error(`Missing page data for route=/fees/chain/[chain] chain=${chain}`)
