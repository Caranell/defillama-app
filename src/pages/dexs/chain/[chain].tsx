...
export const getStaticProps = withPerformanceLogging(
	...
	async ({ params }: GetStaticPropsContext<{ chain: string }>) => {
		...
		addDimensionChainRouteTelemetry({
			...
			canonicalRoute: '/dexs/chain/[chain]',
			dataType,
			metadataFlag: 'dexs'
		})
		...
		const redirectDestination = getChainRouteRedirectDestination(params.chain, chainRoute, 'dexs/chain')
		...
		if (!data) throw new Error(`Missing page data for route=/dexs/chain/[chain] chain=${chain}`)
