...
import { getProtocolsTokenPricesByChain } from '~/containers/ProtocolLists/queries'
...
export const getStaticProps = withPerformanceLogging(
	...
	async ({ params }: GetStaticPropsContext<{ chain: string }>) => {
		...
		const redirectDestination = getChainRouteRedirectDestination(params.chain, chainRoute, 'token-prices/chain')
		...
		if (!data) throw new Error(`Missing page data for route=/token-prices/chain/[chain] chain=${chain}`)
